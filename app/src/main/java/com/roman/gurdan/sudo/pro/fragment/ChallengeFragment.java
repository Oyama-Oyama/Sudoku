        ...
        disposable.add(Observable.just(selectedDate)
          ...
          .subscribe(new Consumer<Boolean>() {
            ...
            public void accept(Boolean aBoolean) throws Throwable {
              if (aBoolean) {
                if (Easy.Companion.getInstance().hasRewarded()) {
                  Easy.Companion.getInstance().addRewardedListener(new IAdListener() {
                    @Override
              ...
              try {
                Easy.Companion.getInstance().logEvent("startChallenge", null);
              } catch (Exception e) {
              }
            }
          }));
